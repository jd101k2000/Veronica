...
filter: progid:DXImageTransform.Microsoft.gradient(startColorstr=\'%s\', endColorstr=\'%s\');}' . "\n";
	...
	$urlfadeup = weaverii_relative_url('images/theme/fadeup.png');
	    weaverii_f_write($sout, sprintf(".menu_bar,.weaveriip_vertical_menu .menu_bar { background-image: url(%s);}\n", $urlfade));
...
/* vertical menu */
    ...
    /* $menu = sprintf(".menu-vertical {clear:both;background:transparent;margin:0;width:100%% !important;overflow:hidden !important;border-bottom:3px solid %s;border-top:1px solid %s;}
...
$text_color, $mb_sub, $text_color, $text_hover, $mb_hover); */
    ...
    $menu = sprintf(".widget-area .menu-vertical,.menu-vertical {clear:both;background:transparent;margin:0;width:100%%;overflow:hidden;border-bottom:3px solid %s;border-top:1px solid %s;}
...
.widget-area .menu-vertical ul ul a,.menu-vertical ul ul a {color: %s; background-color: %s;
 ...
 border-top:1px solid %s;}
.widget-area .menu-vertical ul ul a:hover,.menu-vertical ul ul a:hover {color: %s; background-color: %s; text-decoration: none;}
...
#content tr td {border: 1px solid #888; padding:4px;}\n"));
	...
	weaverii_f_write($sout,sprintf(".blog #content .featured-image img.wp-post-image, .archive #content .featured-image img.wp-post-image, .search #content .featured-image img.wp-post-image,#content .wvr-show-posts .featured-image img.wp-post-image {height: auto; max-width:%spx;}\n",$val));
