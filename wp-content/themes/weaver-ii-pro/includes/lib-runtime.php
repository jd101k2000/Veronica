...
function weaverii_use_inline_css($css_file) {
     return weaverii_getopt_checked('_wii_inline_style') || !weaverii_init_base()
...
?>
    <span class="mobile-menu-link"><a href="javascript:void(null);" onclick="weaverii_ToggleMenu(document.getElementById('<?php echo $menu_id; ?>'), this, '<?php echo $img_show; ?>', '<?php echo $img_hide; ?>')"><?php echo $img_toggle; ?></a></span></div>
</div>
<?php
}
