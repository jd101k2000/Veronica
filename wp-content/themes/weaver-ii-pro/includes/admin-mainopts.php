...
function weaverii_mainopts_header() {
    ...
    array('name' => '<small>Move Title over Header Image</small>', 'id' => 'wii_title_over_header', 'type' => '=checkbox',
	    'info' => 'Check to move the site Title over the Header Image.'),
    array('name' => '#070<small>Also Move on Mobile Views</small>', 'id' => 'wii_title_over_header_mobile', 'type' => '+checkbox',
	    'info' => 'Check to also move the site Title over the Header Image on mobile view. (&#9679;Pro)'),
    array('name' => 'Hide Site Title/Tagline', 'id' => 'wii_hide_site_title', 'type' => '=checkbox',
	    'info' => 'Check to hide display of Site Title, Tagline (Uses "display:none;" : SEO friendly.)'),
    ...
    array('name' => '#070<small>Show Tagline on phone view</small>', 'id' => 'wii_desc_show_mobile', 'type' => '+checkbox',
	    'info' => 'Check to display site Tagline on phone view. (&#9679;Pro)'),
    array('name' => '<small>Move Tagline over Header Image</small>', 'id' => 'wii_desc_over_header', 'type' => '=checkbox',
	    'info' => 'Check to move the site Tagline over the Header Image.'),
    ...
    array('name' => '<small>Move Extra HTML over Header Image</small>', 'id' => 'wii_header_html_over_header', 'type' => '+checkbox',
	    'info' => 'Check to move the Extra HTML over the Header Image. (&#9679;Pro)'),
    ...
    array('name' => 'Obsolete options', 'type' => '=subheader_alt',
	    'info' => 'Obsolete options for backward compatibility - please use new options for title/tagline placement'),

    array('name' => '<small>Title/Tagline over Header Image</small>', 'id' => 'wii_title_on_header', 'type' => '=checkbox',
	    'info' => 'Check to move the site Title and Tagline over the Header Image.'),
    ...
    array('name' => '<small>Tagline Indents</small>', 'id' => 'wii_title_on_header_xy_desc', 'type' => '=text_xy',
	    'info' => 'Adjust default left and top indents for Tagline over Header Image. (default: x:40, y:90)'),
    ...
    array('name' => '#070<small>Hide Header Image on Mobile View</small>', 'id' => 'wii_mobile_hide_header_image', 'type' => '=checkbox',
	    'info' => 'Check to hide display of standard header image when site viewed on phones and small tablet devices.'),
    ...
    array('name' => '<small>Hide Entire Area for Normal View</small>', 'id' => '_wii_hdr_widg_hide_normal', 'type' => '=checkbox',
	  'info' => 'Hide entire header widget area on all pages of normal view (also hides on Mobile Responsive Modes, displays on Mobile &#9688;Smart Modes). &diams;' ),
    array('name' => '#070<small>Hide Entire Area for Mobile View</small>', 'id' => '_wii_hdr_widg_hide_mobile', 'type' => '=checkbox',
    ...
    array('name' => 'Advanced', 'id' => 'a_hdr_advanced', 'type' =>'=subheader',
	  'info' => 'Settings for more advanced users'),
...
function weaverii_mainopts_menus() {
    ...
    array('name' => '#070<small>Threshold for Slide Open Menu</small>', 'id' =>'wii_mobile_slide_threshold' , 'type' => '+val_px',
	  'info' => 'Threshold width for switching to Slide Open Menu. Suggested values: Never: 0 - Phones: 580, Small Tablets: 640, Tablets (portrait): 768, All: 5000. (Default: 640) (&#9679;Pro)'),
    ...
    array('name' => '#070<small>Hide Menu Bars - Desktop</small>', 'id' => 'wii_hide_menu_bar', 'type' => '=checkbox',
	    'info' => "Hides default primary and secondary menu bars, but just on the desktop view. Will still show mobile slide open menu."),
...
// ======================== Main Options > Post Page Specifics ========================
