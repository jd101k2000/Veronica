...
<p>
    ...
    <br />
		<textarea name="<?php weaverii_sapi_main_name('wii_head_opts'); ?>" rows=5 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt('wii_head_opts')); ?></textarea>
<br>
     <small>Weaver II will <em>always</em> load the jQuery Library.</small>
	<!-- ===================================================== -->
  <br /><br />
    <a name="advancedcss" id="advancedcss"></a>
    <div class="wvr-option-subheader">Custom CSS Rules</div><br /><br />
...
rotating image slideshows such as <a href=\"http://www.jleuze.com/plugins/meteor-slides/\" target=\"_blank\">Meteor Slides</a>.", 'help' => ''),
...
repsonsive <em>Mobile Support Modes</em> above, in which case your site will continue to display responsively on desktop browsers and unrecognized mobile devices, while using the alternative plugin for recognized mobile devices.
You can also <em>Disable Mobile Support</em>, in which case you will not get fully responsive desktop support.'),
    ...
    array('name' => '#070<small>Mobile Header Image - Tablet</small>', 'id' => '_wii_mobile_tablet_header_url', 'type' => '+textmedia',
	  'info' => 'Specify alternate header image for tablet mobile view (will ususally not be necessary, &#9688;Smart Modes only). (&#9679;Pro) &diams;'),
...
?>
	...
	<?php weaverii_help_link('help.html#SEO','Help on SEO');?></div><br />
	...
	<!-- ======== -->
        <div class="wvr-option-subheader">SEO/Meta Tags</div><br/>
	...
	<textarea name="<?php weaverii_sapi_main_name('_wii_metainfo'); ?>" rows=4 style="width: 95%"><?php echo(esc_textarea(weaverii_getopt('_wii_metainfo'))); ?></textarea>
	<br>
         <label><em>Use SEO plugin instead:</em> <input type="checkbox" name="<?php weaverii_sapi_main_name('_wii_hide_metainfo'); ?>" id="_wii_hide_metainfo" <?php checked(weaverii_getopt_checked( '_wii_hide_metainfo' )); ?> /></label>
