...
weaverii_add_shortcode('weaver_show_posts', 'weaverii_show_posts_shortcode');
...
weaverii_add_shortcode('weaver_header_image', 'weaverii_sc_header_image');
...
weaverii_add_shortcode('weaver_bloginfo', 'weaverii_sc_bloginfo');
...
weaverii_add_shortcode('weaver_site_title', 'weaverii_sc_site_title');
...
weaverii_add_shortcode('weaver_site_desc', 'weaverii_sc_site_desc');
...
weaverii_add_shortcode('weaver_breadcrumbs', 'weaverii_sc_breadcrumbs');
...
weaverii_add_shortcode('weaver_pagenav', 'weaverii_sc_pagenav');
...
weaverii_add_shortcode('weaver_iframe', 'weaverii_sc_iframe');
...
weaverii_add_shortcode('weaver_show_if_mobile', 'weaverii_sc_show_if_mobile');
...
weaverii_add_shortcode('weaver_hide_if_mobile', 'weaverii_sc_hide_if_mobile');
...
weaverii_add_shortcode('weaver_show_if_logged_in', 'weaverii_sc_show_if_logged_in');
...
weaverii_add_shortcode('weaver_hide_if_logged_in', 'weaverii_sc_hide_if_logged_in');
...
weaverii_add_shortcode('weaver_youtube', 'weaverii_sc_youtube');
...
weaverii_add_shortcode('weaver_vimeo', 'weaverii_sc_vimeo');
...
weaverii_add_shortcode('weaver_html', 'weaverii_sc_html');
...
weaverii_add_shortcode('div', 'weaverii_sc_div');
...
weaverii_add_shortcode('span', 'weaverii_sc_span');
...
weaverii_add_shortcode('weaver_info', 'weaverii_sc_info');
?>
